...
<a href="https://github.com/adamlui/python-utils/releases/tag/project-markers-1.0.2">
...
It's just a [JSON file](https://cdn.jsdelivr.net/gh/adamlui/python-utils@project-markers-1.0.2/project-markers/src/project_markers/project-markers.json), so you can use it in any environment.
