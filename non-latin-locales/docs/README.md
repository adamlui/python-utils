...
<a href="https://github.com/adamlui/python-utils/releases/tag/non-latin-locales-1.0.3">
...
<a href="https://sonarcloud.io/component_measures?metric=vulnerabilities&selected=adamlui_python-utils%3Anon-latin-locales&id=adamlui_python-utils">
...
It's just a [JSON file](https://cdn.jsdelivr.net/gh/adamlui/python-utils@non-latin-locales-1.0.3/non-latin-locales/src/non_latin_locales/non-latin-locales.json), so you can use it in any environment.
