...
<a href="https://github.com/adamlui/python-utils/releases/tag/non-latin-locales-1.0.0">
...
It's just a [JSON file](https://github.com/adamlui/python-utils/blob/non-latin-locales-1.0.0/non-latin-locales/src/non_latin_locales/non_latin_locales.json), so you can use it in any environment.
