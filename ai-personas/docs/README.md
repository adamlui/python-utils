...
<a href="https://github.com/KudoAI/ai-personas/releases/tag/python-v1.14.0">
...
It's just a [JSON file](https://cdn.jsdelivr.net/gh/KudoAI/ai-personas@python-v1.14.0/data/ai-personas.json), so you can use it in any environment.

<img src="https://cdn.jsdelivr.net/gh/KudoAI/ai-personas@python-v1.14.0/assets/images/screenshots/dataset-preview.png">
